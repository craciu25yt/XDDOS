   ...
   public static final String CYAN_BOLD = "\033[1;36m";   // CYAN_BOLD
    ...
    public static void UserFrndly(String[] args) throws Throwable {
        ...
        Scanner in = new Scanner(System.in);
           ...
           Main.methodID = in.nextLine().toLowerCase();
           System.out.print("Time (secons):\n>>");
           Main.duration = Integer.parseInt(in.nextLine());
        ...
        public static void OneLine(String[] args) throws Throwable{
         ...
         Main.serverhp = args[0];
         Main.protcolID = Integer.parseInt(args[1]);
         Main.methodID = args[2].toLowerCase();
         Main.duration = Integer.parseInt(args[3]);
         Main.cpuselect = Integer.parseInt(args[4]);
         ...
         if (args.length == 6) {
            ...
            if (yorn.equalsIgnoreCase("y") || yorn.isEmpty()) {
               ...
               Main.proxyFile = new File("proxies.txt");
